        ...
        */
		...
		function MouseWheelHandler(e) {
			...
			if (options.autoScrolling && !controlPressed) {
				...
				var activeSection = $(SECTION_ACTIVE_SEL);
				activeSection = (typeof activeSection.attr('id') === "undefined") ? $("#section-multiple") : activeSection ;
				var scrollable = isScrollable(activeSection);
				...
				if (canScroll) {
					...
					if (isAccelerating && isScrollingVertically) {
						//scrolling down?
						if (delta < 0) {
							if(activeSection.attr("id") == "section-multiple")
								landscapeScroll($("#section-multiple"),$("#section-4"));
							scrolling('down', scrollable);

							//scrolling up?
						} else {
							if(activeSection.attr("id") == "section-multiple" && $("#section-4").hasClass(ACTIVE))
							{
								window.pvt = false;
								landscapeScroll($("#section-multiple"),$("#section-3"));
								window.setTimeout(function(){window.pvt = true;},600);
							}
							else
							{
								if(window.pvt === true)
		...
		function onkeydown(e) {
			...
			switch (e.which) {
				...
				case 32: //spacebar
					...
					else if(isScrollAllowed.k.down)
					{
						
						if($("#section-multiple").hasClass(ACTIVE))
						{
							window.pvt = false;
							landscapeScroll($("#section-multiple"),$("#section-4"));
							window.setTimeout(function(){window.pvt = true;},600);
						}
						else FP.moveSectionDown();
					}
					break;
				case 40:
				case 34:
